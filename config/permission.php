...
return [
    ...
    // Role permissions structure: role => model => [actions]
    'role_permissions' => [
        'super-admin' => [
        ...
        'doctor' => [
            ...
            'PrescriptionMedicine' => ['create', 'read', 'update'],
            'Subscription' => ['read'],
            'TestRequest' => ['create', 'read', 'update'],
        ...
        'nurse' => [
            ...
            'PrescriptionMedicine' => ['read', 'update'],
            'Subscription' => ['read'],
            'TestRequest' => ['read', 'update'],
            'Ticket' => ['read', 'update'],
            'TicketQueue' => ['read'],
            'User' => ['read'],
        ],
